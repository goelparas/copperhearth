    ...
    <section className="py-24 md:py-32 bg-background overflow-hidden">
      <div className="container mx-auto px-6 max-w-[80rem]">
        <div className="text-center mb-16 md:mb-20">
          ...
          <h2 className="text-foreground">Copper Hearth vs Without Copper</h2>
        </div>
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-[#F8F2EB] p-8 md:p-12 rounded-[1.5rem] border border-[#E5D9CB] relative z-10 shadow-sm"
          >
          ...
          {/* VS Badge */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 hidden lg:flex items-center justify-center w-[4.5rem] h-[4.5rem] bg-brand-forest text-white rounded-full border-4 border-background text-xl font-serif italic shadow-xl">
            vs
          </div>
          <div className="flex lg:hidden items-center justify-center py-6">
            <div className="w-12 h-12 bg-brand-forest text-white rounded-full flex items-center justify-center font-serif italic text-lg shadow-lg">
              vs
            </div>
          </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-bg-soft/50 p-8 md:p-12 rounded-[1.5rem] border border-card-border"
          >
            <h3 className="small-label text-text-muted mb-8">WITHOUT COPPER</h3>
            <ul className="space-y-4 mb-6">
            ...
            <div className="relative aspect-video w-full rounded-2xl overflow-hidden bg-bg-soft flex items-center justify-center border border-divider">
              <span className="text-text-muted/20 text-[0.625rem] uppercase tracking-widest">
                Plain Vessel Placeholder
              </span>
            </div>
          </motion.div>
        </div>
